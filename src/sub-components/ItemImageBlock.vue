<template>
    <div class="pz-pix-box" :data-block-root="prodBlockRoot">
        ...
        <a :href="getDetailPageURI(prodItem)" class="" :data-block-root="prodBlockRoot">
            <img :src="getProductPix()" :data-block-root="prodBlockRoot" class="thumbnail pz-prod-pix" style="width: 100%;">
        </a>
...
<script>
    ...
    export default {
        ...
        methods: {
            getProductPix: function(){
                return (this.prodItem.productPix !== undefined) ? ajaxFetch.restAccessURI + this.prodItem.productPix : '';
            },
